SuperTags.Activate = ClassX.extend(SuperTags.Class, function(base) {
  ...
  this.parseAllTags = function(text, clearTags) {
    var obj = {};
    var ctx = this;
  ...
  this.getTags = function() {
    if(this.settings.tagMode === "tagBox") {
      return this.tags;
    } else if(this.settings.tagMode === "inline") {
      var elem = $("#" + this.settings.inputControl)
      var text = $(elem).text();
      var tagObj = this.parseAllTags(text, true)
      console.log(tagObj);
    }
  }
